...
Route::group(['namespace' => 'Admin','middleware' => ['auth', 'role:admin']], function () {  
	...
	Route::get('/locations/approve/{id}', 'LocationController@approve')->name('locations/approve');
	Route::post('/locations/reject', 'LocationController@reject')->name('locations/reject');
	...
	Route::post('/terms/save', 'HomeController@saveterms')->name('terms/save');
	Route::get('/terms', 'HomeController@terms')->name('terms');
	Route::post('/privacy/save', 'HomeController@saveprivacy')->name('privacy/save');
	Route::get('/privacy', 'HomeController@privacy')->name('privacy');

	Route::get('/cities', 'CityController@index')->name('cities');
	Route::get('/cities/add', 'CityController@add')->name('cities.add');
	...
	Route::post('/cities/save', 'CityController@save')->name('cities.save');
...
Route::group(['namespace' => 'User', 'prefix' => 'user', 'middleware' => ['auth', 'role:user']], function () {
	...
	Route::post('cancel/friend/request', 'FriendsController@CancelFriendRequest')->name('cancel/friend/request');
	...
	Route::get('friend/requests', 'FriendsController@GetFriendRequests')->name('friend/requests');
	Route::get('notifications', 'ProfileController@GetNotifications')->name('notifications');
	...
	Route::post('locations/checkin/create', 'LocationController@CheckinLocation')->name('locations/checkin/create');

	Route::get('favourite/locations', 'LocationController@GetSavedLocations')->name('favourite/locations');

	Route::get('photos', 'ProfileController@GetPhotos')->name('photos');
	Route::get('privacy', 'ProfileController@GetPrivacy')->name('privacy');
	Route::get('terms', 'ProfileController@GetTerms')->name('terms');
});